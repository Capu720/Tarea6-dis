...
public class Servicio
{
  ...
  public Response alta(@FormParam("articulo") Articulo articulo) throws Exception
  {
	...
	stmt_1.setInt(4,articulo.cantidad);
      ...
      {
        PreparedStatement stmt_2 = conexion.prepareStatement("INSERT INTO fotos_articulos(id_foto,foto,id_articulo) VALUES (0,?,(SELECT id_articulo FROM usuarios WHERE nombre=?))");
        try
        {
